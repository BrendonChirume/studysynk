...
const EnhancedTabPanel = ({index, children}: EnhancedTabPanelProps) => {
    return (
...
export default function MyProfile() {
    return (
        ...
        >
            <Typography level="h1" fontSize="xl2" sx={{my: 3}}>
                My profile
            </Typography>
            <Tabs defaultValue={0} sx={{bgcolor: 'transparent'}}>
                ...
                >
                    ...
                    <Tab indicatorInset value={1}>
                        Schools{' '}
                        <Chip size="sm" variant="soft" color="neutral" sx={{ml: 1, mb: 0.5}}>
                            1
                        </Chip>
                    </Tab>
                </TabList>
                <EnhancedTabPanel index={0}>
